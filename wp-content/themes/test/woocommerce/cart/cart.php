						...
						<?php foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item): ?>
							...
							<?php if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)): ?>
								<?php
									...
									$product_add_to_cart_url   = do_shortcode('[add_to_cart_url id="' . $_product->get_id() . '"]');
								?>

								<figure class="product-card">
									<a href="<?php echo $product_url; ?>" class="product-image">
										<img src="http://sport/wp-content/uploads/woocommerce-placeholder.png" alt="">
									</a>
									<figcaption class="product-info">
										<div class="product-text">
											<h2 class="product-title"><a href="<?php echo $product_url; ?>"><?php echo $product_name; ?></a></h2>
											<a href="<?php echo $product_remove_url; ?>" class="product-del-from-cart icon-cart">Удалить</a>
										</div>

										<div class="product-count">
												<!-- <input type="number" id="quantity_5f7b18c78eda7" class="input-text qty text" step="1" min="0" max="" name="cart[36660e59856b4de58a219bcf4e27eba3][qty]" value="6" title="Кол-во" size="4" placeholder="" inputmode="numeric"> -->
											...
											<span class="product-price"><?php echo $product_subtotal; ?></span>
										</div>
									</figcaption>
								</figure>
